...
:: Stub for ioc_arxml
rem COPY "%PRJ_DIR%\Static_Code\Reference_Code\stub\os_ioc.arxml_" "%PRJ_DIR%\Generated\Bsw_Output\xml\os_ioc.arxml"

SET INPUT_FILE_YML=%PRJ_DIR%\Build\input_files.yml
SET BASE_DIR=%PRJ_DIR%
SET MODULE_TOP_PATH=%PRJ_DIR%\Static_Code\Modules
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\Os_R44\generator\Bswmdt_Os.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\Os_R44\generator\Swcdt_Bsw_Os.template
