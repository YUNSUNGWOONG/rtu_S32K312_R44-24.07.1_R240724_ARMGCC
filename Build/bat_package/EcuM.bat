...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\EcuM_R44\generator\Bswmdt_EcuM.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\EcuM_R44\generator\Swcdt_Bsw_EcuM.template
