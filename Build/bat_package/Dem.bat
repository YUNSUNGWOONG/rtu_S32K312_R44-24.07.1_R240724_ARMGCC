...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\Dem_R44\generator\Bswmdt_Dem.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\Dem_R44\generator\Swcdt_Bsw_Dem.template
