...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\J1939Rm_R44\generator\Bswmdt_J1939Rm.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\J1939Rm_R44\generator\Swcdt_Bsw_J1939Rm.template
