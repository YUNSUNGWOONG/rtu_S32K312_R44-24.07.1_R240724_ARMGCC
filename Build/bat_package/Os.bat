...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\Os_S32K31x_R44\generator\Bswmdt_Os.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\Os_S32K31x_R44\generator\Swcdt_Bsw_Os.template
