...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\SecOC_R44\generator\Bswmdt_SecOC.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\SecOC_R44\generator\Swcdt_Bsw_SecOC.template
