...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\DoIP_R44\generator\Bswmdt_DoIP.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\DoIp_R44\generator\Swcdt_Bsw_DoIP.template
...
rem COPY %PRJ_DIR%\Generated\Bsw_Output\bswmd\Bswmd_%MODULES%.arxml %PRJ_DIR%\Configuration\System\Bswmd\Bswmd_%MODULES%.arxml
EXIT 0
