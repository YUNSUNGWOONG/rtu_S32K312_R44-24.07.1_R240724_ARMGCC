...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\Det_R44\generator\Bswmdt_Det.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\Det_R44\generator\Swcdt_Bsw_Det.template
