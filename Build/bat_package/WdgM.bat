...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\WdgM_R44\generator\Bswmdt_WdgM.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\WdgM_R44\generator\Swcdt_Bsw_WdgM.template
