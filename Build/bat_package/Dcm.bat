...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\Dcm_R44\generator\Bswmdt_Dcm.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\Dcm_R44\generator\Swcdt_Bsw_Dcm.template
