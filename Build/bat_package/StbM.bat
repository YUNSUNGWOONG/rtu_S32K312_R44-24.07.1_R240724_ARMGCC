...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\StbM_R44\generator\Bswmdt_StbM.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\StbM_R44\generator\Swcdt_Bsw_StbM.template
