...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\CanTrcv_R44\generator\Bswmdt_CanTrcv.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\CanTrcv_R44\generator\Swcdt_CanTrcv.template
