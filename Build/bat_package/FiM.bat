...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\FiM_R44\generator\Bswmdt_FiM.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\FiM_R44\generator\Swcdt_Bsw_FiM.template
