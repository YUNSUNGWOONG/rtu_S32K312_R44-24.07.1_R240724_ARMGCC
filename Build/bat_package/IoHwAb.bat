...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\IoHwAb_R44\generator\Bswmdt_IoHwAb.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\IoHwAb_R44\generator\Swcdt_Bsw_IoHwAb.template
