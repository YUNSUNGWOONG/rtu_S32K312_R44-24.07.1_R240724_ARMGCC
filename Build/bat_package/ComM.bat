...
SET BSWMDT=%PRJ_DIR%\Static_Code\Modules\ComM_R44\generator\Bswmdt_ComM.template
SET SWCDT=%PRJ_DIR%\Static_Code\Modules\ComM_R44\generator\Swcdt_Bsw_ComM.template
