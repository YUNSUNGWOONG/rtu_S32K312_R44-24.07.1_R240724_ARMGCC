...
#define WDG_43_INSTANCE1_IPW_AR_RELEASE_MINOR_VERSION_PBCFG_C     7
#define WDG_43_INSTANCE1_IPW_AR_RELEASE_REVISION_VERSION_PBCFG_C  0
#define WDG_43_INSTANCE1_IPW_SW_MAJOR_VERSION_PBCFG_C             3
#define WDG_43_INSTANCE1_IPW_SW_MINOR_VERSION_PBCFG_C             0
#define WDG_43_INSTANCE1_IPW_SW_PATCH_VERSION_PBCFG_C             0
