...
extern void Wdg_76_Acw_Cbk_GptNotification(void);
...
{
    0, /* Logical Channel GptChannelConfiguration_STM*/
    1, /* Logical Channel GptChannelConfiguration_WdgTrig*/
    2, /* Logical Channel GptChannelConfiguration_WdgExt*/
    3, /* Logical Channel GptChannelConfiguration_OsDebug*/
    4  /* Logical Channel GptChannelConfiguration_Test*/
};
...
{
    {   /*GptChannelConfiguration_STM configuration data*/
...
,
    {   /*GptChannelConfiguration_WdgExt configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        &Wdg_76_Acw_Cbk_GptNotification, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
#endif
        (Gpt_ValueType)(4294967295U), /* Maximum ticks value*/
...
,
    {   /*GptChannelConfiguration_OsDebug configuration data*/
        (boolean)FALSE, /* Wakeup capability */
        NULL_PTR, /* Channel notification */
#if ((GPT_WAKEUP_FUNCTIONALITY_API == STD_ON) && (GPT_REPORT_WAKEUP_SOURCE == STD_ON))
        (EcuM_WakeupSourceType)0U, /* Wakeup information */
...
,
    {   /*GptChannelConfiguration_Test configuration data*/
        (boolean)FALSE, /* Wakeup capability */
