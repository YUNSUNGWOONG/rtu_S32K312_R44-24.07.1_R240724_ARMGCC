...
Gpt_Ipw_HwInstanceConfigType Gpt_Ipw_HwInstanceConfig_PB[4U]=
{
    {
        /** @brief IP type  */
        GPT_PIT_MODULE,
 ...
 */
Gpt_Ipw_HwChannelConfigType Gpt_Ipw_ChannelConfig_PB[5U] =
{
    /** @brief GptChannelConfiguration_STM */
    {
        /** @brief IP type  */
        GPT_STM_MODULE,
        /** @brief IP instance */
    ...
    ,
    /** @brief GptChannelConfiguration_WdgExt */
    {
        /** @brief IP type  */
        GPT_PIT_MODULE,
        /** @brief IP instance */
    ...
    ,
    /** @brief GptChannelConfiguration_OsDebug */
    {
        /** @brief IP type  */
        GPT_EMIOS_MODULE,
        /** @brief IP instance */
        ...
        /** @brief IP instance config pointer */
        {
            ...
            NULL_PTR,
            NULL_PTR,
            &EMIOS_0_ChannelConfig_PB[0U]
        }
    }
    ,
    /** @brief GptChannelConfiguration_Test */
    {
        /** @brief IP type  */
        GPT_EMIOS_MODULE,
        /** @brief IP instance */
