...
*/
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_STM  (0U)
            
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_WdgTrig  (1U)
            
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_WdgExt  (2U)
            
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_OsDebug  (3U)
            
    #define GptConf_GptChannelConfiguration_GptChannelConfiguration_Test  (4U)
