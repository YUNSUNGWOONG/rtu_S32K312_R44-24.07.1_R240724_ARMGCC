...
#define C40_DATA_FLASH_ERROR_SUPPRESSION    (STD_ON)

#define FLS_BLOCK_4_PIPE_SELECTABLE         (STD_OFF)
...
#define FLS_CODE_BLOCK_SIZE                 (0x200000U)
...
#define FLASH_REGION_2_ADDR                 (FLS_DATA_BLOCK_BASE_ADDR)
#define FLASH_REGION_3_ADDR                 (FLS_INVALID_ADDR)
#define FLASH_REGION_4_ADDR                 (FLS_INVALID_ADDR)
