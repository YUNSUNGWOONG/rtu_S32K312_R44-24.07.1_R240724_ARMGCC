...
*/
#define EMIOS_GPT_IP_USED (STD_ON)
/*================================================================================================*/
/**
...
#define GPT_EMIOS_0_CH_7_ISR_USED
                #define GPT_EMIOS_0_CH_8_ISR_USED
                #define GPT_EMIOS_0_CH_16_ISR_USED
...
/* Macros that indicate EMIOS interrupts used by GPT. */
        ...
        #define GPT_EMIOS_0_CH_8_ISR_USED
        #define EMIOS_0_CH_8_ISR_USED
    #else
        #error "EMIOS_0_CH_8 interrupt cannot be used by Gpt driver. Channel locked by other driver!"
    #endif

    #ifndef EMIOS_0_CH_16_ISR_USED
        #define GPT_EMIOS_0_CH_16_ISR_USED
        #define EMIOS_0_CH_16_ISR_USED
    #else
        #error "EMIOS_0_CH_16 interrupt cannot be used by Gpt driver. Channel locked by other driver!"
    #endif
