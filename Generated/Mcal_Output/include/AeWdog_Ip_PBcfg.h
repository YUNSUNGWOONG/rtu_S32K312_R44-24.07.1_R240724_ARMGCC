...
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if AeWdog_Ip_PBcfg.h and AeWdog_Ip_Cfg_Defines.h are of the same vendor */
#if (AEWDOG_IP_PBCFG_VENDOR_ID != AEWDOG_IP_CFG_DEFINES_VENDOR_ID)
#error "AeWdog_Ip_PBcfg.h and AeWdog_Ip_Cfg_Defines.h have different vendor ids"
#endif

/* Check if AeWdog_Ip_PBcfg.h and AeWdog_Ip_Cfg_Defines.h are of the same Autosar version */
...
#error "AutoSar Version Numbers of AeWdog_Ip_PBcfg.h and AeWdog_Ip_Cfg_Defines.h are different"
#endif

/* Check if AeWdog_Ip_PBcfg.h and AeWdog_Ip_Cfg_Defines.h are of the same Software version */
...
#error "Software Version Numbers of AeWdog_Ip_PBcfg.h and AeWdog_Ip_Cfg_Defines.h are different"
#endif

/* Check if AeWdog_Ip_PBcfg.h and AeWdog_Ip_Types.h are of the same vendor */
#if (AEWDOG_IP_PBCFG_VENDOR_ID != AEWDOG_IP_TYPES_VENDOR_ID)
#error "AeWdog_Ip_PBcfg.h and AeWdog_Ip_Types.h have different vendor ids"
#endif

/* Check if AeWdog_Ip_PBcfg.h and AeWdog_Ip_Types.h are of the same Autosar version */
...
#error "AutoSar Version Numbers of AeWdog_Ip_PBcfg.h and AeWdog_Ip_Types.h are different"
#endif

/* Check if AeWdog_Ip_PBcfg.h and AeWdog_Ip_Types.h are of the same Software version */
...
#error "Software Version Numbers of AeWdog_Ip_PBcfg.h and AeWdog_Ip_Types.h are different"
#endif
/*==================================================================================================
*                                            CONSTANTS
==================================================================================================*/
