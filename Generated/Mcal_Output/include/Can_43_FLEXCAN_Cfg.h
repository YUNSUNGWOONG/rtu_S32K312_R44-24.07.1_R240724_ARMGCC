...
*/
#define CanMainFunctionRWPeriods    0U
...
*/
#define CAN_43_FLEXCAN_MAINFUNCTION_MODE_PERIOD    (0.005F)
...
*/
#define CAN_43_FLEXCAN_HWOBJECT_CONFIG_COUNT    ((Can_HwHandleType)14U)

/**
*   @brief      Symbolic Name generated for Can Controller
*/
#define ECU1_FD_CAN1    ((uint8)0U)

/**
*   @brief      Symbolic Name generated for Can HardwareObject
*/
#define IN_HwObj_ECU1_FD_CAN1_0x205_FD_CAN1_V_CGW_02_A    ((Can_HwHandleType)0U)
#define IN_HwObj_ECU1_FD_CAN1_0x18c_FD_CAN1_BSD_01_50ms_P11    ((Can_HwHandleType)1U)
#define IN_HwObj_ECU1_FD_CAN1_0x7df_FD_CAN1_Diag_Msg_TP_Func_FD_CAN1    ((Can_HwHandleType)2U)
#define IN_HwObj_ECU1_FD_CAN1_0x650_FD_CAN1_AtmReq    ((Can_HwHandleType)3U)
#define IN_HwObj_0x500_0x57f_ECU1_FD_CAN1_NM_Message    ((Can_HwHandleType)4U)
#define IN_HwObj_0x748_0x77e_ECU1_FD_CAN1    ((Can_HwHandleType)5U)
#define OUT_HwObj_ECU1_FD_CAN1_0x760_FD_CAN1_Diag_Msg_TP_Phys_Res_FD_CAN1    ((Can_HwHandleType)6U)
#define OUT_HwObj_ECU1_FD_CAN1_0x75a_FD_CAN1_Normal_Msg_FD_TP_01_A    ((Can_HwHandleType)7U)
#define OUT_HwObj_ECU1_FD_CAN1_0x651_FD_CAN1_AtmResp    ((Can_HwHandleType)8U)
#define OUT_HwObj_ECU1_FD_CAN1_0x502_FD_CAN1_NM_CGW    ((Can_HwHandleType)9U)
#define OUT_HwObj_ECU1_FD_CAN1_0x400_FD_CAN1_AHLS_01_300ms    ((Can_HwHandleType)10U)
#define OUT_HwObj_ECU1_FD_CAN1_0x2b0_FD_CAN1_AFLS_01_100ms    ((Can_HwHandleType)11U)
#define OUT_HwObj_ECU1_FD_CAN1_0x202_FD_CAN1_V_CGW_01_B    ((Can_HwHandleType)12U)
#define OUT_HwObj_ECU1_FD_CAN1_0x42_FD_CAN1_TCU_01_10ms_P11    ((Can_HwHandleType)13U)
