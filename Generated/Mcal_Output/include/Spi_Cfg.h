...
*/
#define SpiConf_SpiChannel_EEP_ADDR_CH    ((Spi_ChannelType)0)
#define SpiConf_SpiChannel_EEP_CMD_CH    ((Spi_ChannelType)1)
#define SpiConf_SpiChannel_EEP_DATA_CH    ((Spi_ChannelType)2)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_EEP_JOB_CMD   ((Spi_JobType)0)
#define SpiConf_SpiJob_EEP_JOB_DATA   ((Spi_JobType)1)
#define SpiConf_SpiJob_EEP_JOB_STAT   ((Spi_JobType)2)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_EEP_SEQ_CMD   ((Spi_SequenceType)0)
#define SpiConf_SpiSequence_EEP_SEQ_DATA   ((Spi_SequenceType)1)
#define SpiConf_SpiSequence_EEP_SEQ_STAT   ((Spi_SequenceType)2)
