...
*/
#define SWT_IP_INSTANCE0_INITIAL_TIMEOUT_U16 ((uint16)4000)
#define SWT_IP_INSTANCE0_MAX_TIMEOUT_U16 ((uint16)4200)

/**
* @brief  This macros indicate the Wdg timeout value for Wdg module.
*/

#define SWT_IP_INSTANCE0_TIMEOUT_VALUE_ARRAY  {(uint32)0,(uint32)500, (uint32)100}
/**
...
*/
#define SWT_IP_CLEAR_RESET_REQUEST_INSTANCE0 (STD_OFF)
...
#define SWT_IP_ISR0_USED (STD_OFF)
