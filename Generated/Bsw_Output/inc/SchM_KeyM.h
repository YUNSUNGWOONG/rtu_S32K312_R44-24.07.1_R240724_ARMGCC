...
extern FUNC(EcuM_StateType, RTE_CODE) SchM_Mode_KeyM_modeNotificationPort_KeyMEcuShutdown(P2VAR(EcuM_StateType, AUTOMATIC, RTE_APPL_DATA) previousMode,P2VAR(EcuM_StateType, AUTOMATIC, RTE_APPL_DATA) nextMode);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
...
#define SchM_Enter_KeyM_GLOBALVAR_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_KeyM_GLOBALVAR_PROTECTION() do {\
 \
