...
extern CONST(EcuM_ConfigType, ECUM_CONST) EcuM_Config_Variant_FL;
...
/* Macro for number of variant postbuild support */
#define   ECUM_NO_OF_PB_VARIANT_CONFIGS                                       1U
