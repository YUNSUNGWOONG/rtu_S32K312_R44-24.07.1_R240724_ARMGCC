...
#define SchM_Enter_CanSM_MODE_STATUS_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_CanSM_MODE_STATUS_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_CanSM_BUSOFF_STATUS_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_CanSM_BUSOFF_STATUS_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
