...
#define SchM_Enter_PduR_TP_TX_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_PduR_TP_TX_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_PduR_MULTICAST_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_PduR_MULTICAST_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_PduR_TP_GATEWAY_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_PduR_TP_GATEWAY_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_PduR_GROUP_STATUS_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_PduR_GROUP_STATUS_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_PduR_DATA_BUFFER_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_PduR_DATA_BUFFER_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_PduR_FIFO_STATUS_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_PduR_FIFO_STATUS_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
