...
#define SchM_Enter_Dem_REQUEST_DEBOUNCETIMEBASED() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_REQUEST_DEBOUNCETIMEBASED() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dem_REQUEST_RECORD_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_REQUEST_RECORD_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dem_REQUEST_OCC_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_REQUEST_OCC_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dem_REQUEST_STATUS_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_REQUEST_STATUS_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dem_REQUEST_BUFFER_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_REQUEST_BUFFER_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dem_REQUEST_NVDATA_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_REQUEST_NVDATA_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dem_CAPTURE_OBD_DATA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_CAPTURE_OBD_DATA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dem_REQUEST_DATA_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_REQUEST_DATA_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dem_REQUEST_OCCTIME_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dem_REQUEST_OCCTIME_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
