...
** 0.0.9     18-Sep-2020   ThanhNH5     Fixed memory sections issue(#15679)   **
** 0.0.10    05-Oct-2020   ThanhNH5     Merge variables in single and         **
**                                      multi core (#15485)                   **
*******************************************************************************/
...
* GENERATED ON:    11-Nov-2024 - 12:55:44                       
*/
...
**                      Macros                                                **
*******************************************************************************/
#ifndef WDGM_INV_GLOBAL_STATUS_DEACTIVATED_DEFAULT
#define WDGM_INV_GLOBAL_STATUS_DEACTIVATED_DEFAULT                          251U
#endif /* WDGM_INV_GLOBAL_STATUS_DEACTIVATED_DEFAULT */
...
extern VAR(boolean, WDGM_VAR_NOINIT) WdgM_FirstExpSEIDStatus;
...
extern VAR(WdgM_SupervisedEntityIdType, WDGM_VAR_NOINIT) WdgM_FirstExpiredSEID;
...
extern VAR(WdgM_SupervisedEntityIdType, WDGM_VAR_NOINIT) WdgM_InvFirstExpiredSEID;
#define WDGM_STOP_SEC_VAR_NO_INIT_ASIL_D_GLOBAL_UNSPECIFIED
#include "MemMap.h"
...
#include "MemMap.h"
extern VAR(WdgM_ModeType, WDGM_VAR_POWER_ON_INIT) WdgM_CurrentMode_0;
...
#include "MemMap.h"
extern VAR(uint8, WDGM_VAR_POWER_ON_INIT) WdgM_SEStatus_300;
...
#include "MemMap.h"
extern VAR(uint32, WDGM_VAR_POWER_ON_INIT) WdgM_FreeRunningCounter_0;
...
#include "MemMap.h"
extern VAR(boolean, WDGM_VAR_POWER_ON_INIT) WdgM_AlreadyUpdated_300;
