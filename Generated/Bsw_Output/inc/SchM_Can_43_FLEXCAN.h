...
**  Module Name : RTE                                                         **
**                                                                            **
**  File Name : SchM_Can_43_FLEXCAN.h                                         **
**                                                                            **
...
/*                              Header Inclusion                              */
/******************************************************************************/
#include "SchM_Can_43_FLEXCANType.h"
#include "Rte.h"
#include "Os.h"
...
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_17() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_17() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_00() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_00() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_09() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_09() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_04() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_04() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_16() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_16() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_11() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_11() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_08() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_08() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_03() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_03() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_15() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_15() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_10() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_10() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_07() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_07() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_19() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_19() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_02() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_02() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_14() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_14() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_06() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_06() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_18() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_18() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_01() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_01() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_13() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_13() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_20() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_20() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_05() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Can_43_FLEXCAN_CAN_EXCLUSIVE_AREA_05() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);

/******************************************************************************/
/*                       BSW Module Entities Prototypes                       */
/******************************************************************************/
#define CAN_43_FLEXCAN_START_SEC_CODE
#include "MemMap.h"
FUNC(void, CAN_43_FLEXCAN_CODE) Can_43_FLEXCAN_MainFunction_Mode(void);
#define CAN_43_FLEXCAN_STOP_SEC_CODE
#include "MemMap.h"

#define CAN_43_FLEXCAN_START_SEC_CODE
#include "MemMap.h"
FUNC(void, CAN_43_FLEXCAN_CODE) Can_43_FLEXCAN_MainFunction_Write(void);
#define CAN_43_FLEXCAN_STOP_SEC_CODE
#include "MemMap.h"

#define CAN_43_FLEXCAN_START_SEC_CODE
#include "MemMap.h"
FUNC(void, CAN_43_FLEXCAN_CODE) Can_43_FLEXCAN_MainFunction_Wakeup(void);
#define CAN_43_FLEXCAN_STOP_SEC_CODE
#include "MemMap.h"

#define CAN_43_FLEXCAN_START_SEC_CODE
#include "MemMap.h"
FUNC(void, CAN_43_FLEXCAN_CODE) Can_43_FLEXCAN_MainFunction_BusOff(void);
#define CAN_43_FLEXCAN_STOP_SEC_CODE
#include "MemMap.h"

#define CAN_43_FLEXCAN_START_SEC_CODE
#include "MemMap.h"
FUNC(void, CAN_43_FLEXCAN_CODE) Can_43_FLEXCAN_MainFunction_Read(void);
#define CAN_43_FLEXCAN_STOP_SEC_CODE
#include "MemMap.h"
