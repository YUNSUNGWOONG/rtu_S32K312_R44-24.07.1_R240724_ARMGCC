...
#define RTE_FiM_START_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
extern CONSTP2CONST(Rte_CDS_FiM, RTE_CONST, RTE_CONST) Rte_Inst_FiM;
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_FiM_STOP_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
...
#ifndef RTE_RUNNABLE_SetFunctionAvailable
#define RTE_RUNNABLE_SetFunctionAvailable FiM_SetFunctionAvailable
#endif
...
FUNC(Std_ReturnType, FiM_CODE) FiM_GetFunctionPermission(VAR(FiM_FunctionIdType, AUTOMATIC) PDA_1, P2VAR(boolean, AUTOMATIC, RTE_APPL_DATA) Permission);
#define FiM_STOP_SEC_CODE
#include "FiM_MemMap.h"

#define FiM_START_SEC_CODE
#include "FiM_MemMap.h"
FUNC(Std_ReturnType, FiM_CODE) FiM_SetFunctionAvailable(VAR(FiM_FunctionIdType, AUTOMATIC) PDA_1, VAR(boolean, AUTOMATIC) Availability);
#define FiM_STOP_SEC_CODE
#include "FiM_MemMap.h"
