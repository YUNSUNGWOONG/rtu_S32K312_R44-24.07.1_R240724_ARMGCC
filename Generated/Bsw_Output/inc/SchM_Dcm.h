...
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmResponseOnEvent_OnDTCStatusChange(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_Dcm_DcmResponseOnEvent_OnDTCStatusChange(void);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmDiagnosticSessionControl(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmEcuReset(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmCommunicationControl_ComMChannel_FD_CAN1(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_Dcm_DcmCommunicationControl_ComMChannel_FD_CAN1(void);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmModeRapidPowerShutDown(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_Dcm_DcmApplicationUpdated(void);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmApplicationUpdated(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmControlDTCSetting(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_Dcm_DcmResponseOnEvent_OnChangeOfDataIdentifier(void);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmResponseOnEvent_OnChangeOfDataIdentifier(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_Dcm_DcmSecurityAccess(void);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_Dcm_DcmSecurityAccess(CONST(uint8, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define SchM_Enter_Dcm_TimerProtection() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dcm_TimerProtection() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dcm_DATA_UPDATE() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dcm_DATA_UPDATE() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dcm_SIGNAL_DATA_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dcm_SIGNAL_DATA_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dcm_RxLengthProtection() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dcm_RxLengthProtection() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dcm_RxPduIdProtection() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dcm_RxPduIdProtection() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Dcm_ProtclProtection() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Dcm_ProtclProtection() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
