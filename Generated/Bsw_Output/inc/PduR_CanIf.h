...
extern FUNC(void, PDUR_CODE) PduR_CanIfTxConfirmation(PduIdType txPduId,
Std_ReturnType result);

/* Extern Declaration for PduR_CanIfTriggerTransmit() API */
extern FUNC(Std_ReturnType, PDUR_CODE) PduR_CanIfTriggerTransmit(PduIdType txPduId,
P2VAR(PduInfoType, AUTOMATIC, PDUR_CONST) ptrPduInfoPtr);

/* Extern Declaration for PduR_CanIfRxIndication() API */
extern FUNC(void, PDUR_CODE) PduR_CanIfRxIndication(PduIdType rxPduId,
