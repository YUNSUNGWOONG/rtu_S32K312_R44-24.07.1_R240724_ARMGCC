...
/******************************************************************************/
#ifndef RTE_CDD_LIN_H
#define RTE_CDD_LIN_H
...
/******************************************************************************/
typedef struct Rte_CDS_CDD_LIN Rte_CDS_CDD_LIN;
...
#define RTE_CDD_LIN_START_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
extern CONSTP2CONST(Rte_CDS_CDD_LIN, RTE_CONST, RTE_CONST) Rte_Inst_CDD_LIN;
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_CDD_LIN_STOP_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"

/******************************************************************************/
/*                         Runnable Prototype Mapping                         */
/******************************************************************************/
#ifndef RTE_RUNNABLE_RE_CB_AfterSchedule
#define RTE_RUNNABLE_RE_CB_AfterSchedule RE_CB_AfterSchedule
#endif

#ifndef RTE_RUNNABLE_RE_CB_Error
#define RTE_RUNNABLE_RE_CB_Error RE_CB_Error
#endif

/******************************************************************************/
/*                             Runnable Prototype                             */
/******************************************************************************/
#define CDD_LIN_START_SEC_CODE
#include "CDD_LIN_MemMap.h"
FUNC(void, CDD_LIN_CODE) RE_CB_AfterSchedule(void);
#define CDD_LIN_STOP_SEC_CODE
#include "CDD_LIN_MemMap.h"

#define CDD_LIN_START_SEC_CODE
#include "CDD_LIN_MemMap.h"
FUNC(void, CDD_LIN_CODE) RE_CB_Error(void);
#define CDD_LIN_STOP_SEC_CODE
#include "CDD_LIN_MemMap.h"
...
#ifndef Rte_Call_CallbackAfterSchedule_lin_after_schedule
#define Rte_Call_CallbackAfterSchedule_lin_after_schedule Rte_Call_CDD_LIN_CallbackAfterSchedule_lin_after_schedule
#endif

#ifndef Rte_Call_CallbackError_lin_cbk_err
#define Rte_Call_CallbackError_lin_cbk_err Rte_Call_CDD_LIN_CallbackError_lin_cbk_err
#endif
...
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_CDD_LIN_CallbackAfterSchedule_lin_after_schedule(VAR(uint8, AUTOMATIC) channelId,VAR(uint8, AUTOMATIC) schId,VAR(uint8, AUTOMATIC) schEntryNum,VAR(uint8, AUTOMATIC) frameId);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
...
#define RTE_CDD_LIN_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_CDD_LIN_CallbackError_lin_cbk_err(VAR(uint8, AUTOMATIC) channelId,VAR(uint8, AUTOMATIC) errcode,VAR(uint8, AUTOMATIC) schEntryNum,VAR(uint8, AUTOMATIC) frameId);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_CDD_LIN_STOP_SEC_CODE_ASIL_D
