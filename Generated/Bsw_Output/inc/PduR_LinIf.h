...
#include "MemMap.h"
/* Extern Declaration for PduR_LinIfTxConfirmation() API */
extern FUNC(void, PDUR_CODE) PduR_LinIfTxConfirmation(PduIdType txPduId,
Std_ReturnType result);

/* Extern Declaration for PduR_LinIfTriggerTransmit() API */
extern FUNC(Std_ReturnType, PDUR_CODE) PduR_LinIfTriggerTransmit(PduIdType txPduId,
P2VAR(PduInfoType, AUTOMATIC, PDUR_CONST) ptrPduInfoPtr);

/* Extern Declaration for PduR_LinIfRxIndication() API */
extern FUNC(void, PDUR_CODE) PduR_LinIfRxIndication(PduIdType rxPduId,
