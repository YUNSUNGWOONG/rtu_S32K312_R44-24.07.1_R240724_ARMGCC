...
**  Module Name : RTE                                                         **
**                                                                            **
**  File Name : SchM_Lin_43_LPUART_FLEXIO.h                                   **
**                                                                            **
...
/*                              Header Inclusion                              */
/******************************************************************************/
#include "SchM_Lin_43_LPUART_FLEXIOType.h"
#include "Rte.h"
#include "Os.h"
...
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_17() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_17() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_11() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_11() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_27() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_27() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_09() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_09() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_24() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_24() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_21() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_21() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_19() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_19() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_16() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_16() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_13() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_13() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_10() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_10() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_26() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_26() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_08() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_08() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_23() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_23() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_20() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_20() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_18() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_18() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_15() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_15() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_25() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_25() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_22() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Lin_43_LPUART_FLEXIO_LIN_EXCLUSIVE_AREA_22() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
