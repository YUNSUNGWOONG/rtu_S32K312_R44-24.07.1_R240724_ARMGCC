...
#include "MemMap.h"
/* Extern Declaration for PduR_LinTpStartOfReception() API */
...
/* Extern Declaration for PduR_LinTpCopyTxData() API */
extern FUNC(BufReq_ReturnType, PDUR_CODE) PduR_LinTpCopyTxData(PduIdType txPduId,
...
/* Extern Declaration for PduR_LinTpCopyRxData() API */
extern FUNC(BufReq_ReturnType, PDUR_CODE) PduR_LinTpCopyRxData(
PduIdType rxPduId, 
P2CONST(PduInfoType, AUTOMATIC, PDUR_DATA) pduInfoPtr, 
P2VAR(PduLengthType, AUTOMATIC, PDUR_DATA) bufferSizePtr);

/* Extern Declaration for PduR_LinTpRxIndication() API */
extern FUNC(void, PDUR_CODE) PduR_LinTpRxIndication(PduIdType rxPduId,
Std_ReturnType result);

/* Extern Declaration for PduR_LinTpTxConfirmation() API */
extern FUNC(void, PDUR_CODE) PduR_LinTpTxConfirmation(PduIdType txPduId, Std_ReturnType result);
