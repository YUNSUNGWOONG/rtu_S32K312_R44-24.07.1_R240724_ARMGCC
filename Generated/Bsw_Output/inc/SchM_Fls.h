...
#define SchM_Enter_Fls_FLS_EXCLUSIVE_AREA_10() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Fls_FLS_EXCLUSIVE_AREA_10() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Fls_FLS_EXCLUSIVE_AREA_11() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Fls_FLS_EXCLUSIVE_AREA_11() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Fls_FLS_EXCLUSIVE_AREA_12() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Fls_FLS_EXCLUSIVE_AREA_12() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Fls_FLS_EXCLUSIVE_AREA_13() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Fls_FLS_EXCLUSIVE_AREA_13() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Fls_FLS_EXCLUSIVE_AREA_14() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Fls_FLS_EXCLUSIVE_AREA_14() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
