...
/******************************************************************************/
typedef struct Rte_CDS_Fota Rte_CDS_Fota;
...
#define RTE_Fota_START_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
extern CONSTP2CONST(Rte_CDS_Fota, RTE_CONST, RTE_CONST) Rte_Inst_Fota;
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_Fota_STOP_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
...
#define Fota_START_SEC_CODE
#include "Fota_MemMap.h"
FUNC(Std_ReturnType, Fota_CODE) Fota_SupplierNotification_ServiceRequest_Indication(VAR(uint8, AUTOMATIC) SID, P2CONST(uint8, AUTOMATIC, RTE_APPL_CONST) RequestData, VAR(uint16, AUTOMATIC) DataSize, VAR(uint8, AUTOMATIC) ReqType, VAR(uint16, AUTOMATIC) ConnectionId, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_APPL_DATA) ErrorCode, VAR(Dcm_ProtocolType, AUTOMATIC) ProtocolType, VAR(uint16, AUTOMATIC) TesterSourceAddress);
#define Fota_STOP_SEC_CODE
#include "Fota_MemMap.h"
...
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Fota_Fota_StateRequest_RequestReset(VAR(EcuM_UserType, AUTOMATIC) user);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
