...
#define SchM_Enter_NvM_RAM_STATUS_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_NvM_RAM_STATUS_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_NvM_RAM_INDEX() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_NvM_RAM_INDEX() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
