...
#define RTE_DET_START_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
extern CONSTP2CONST(Rte_CDS_DET, RTE_CONST, RTE_CONST) Rte_Inst_DET;
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_DET_STOP_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
...
#ifndef RTE_RUNNABLE_ReportRuntimeError
...
FUNC(Std_ReturnType, DET_CODE) Det_ReportError(VAR(uint16, AUTOMATIC) PDA_1, VAR(uint8, AUTOMATIC) PDA_2, VAR(uint8, AUTOMATIC) ApiId, VAR(uint8, AUTOMATIC) ErrorId);
#define DET_STOP_SEC_CODE
#include "DET_MemMap.h"

#define DET_START_SEC_CODE
#include "DET_MemMap.h"
FUNC(Std_ReturnType, DET_CODE) Det_ReportRuntimeError(VAR(uint16, AUTOMATIC) PDA_1, VAR(uint8, AUTOMATIC) PDA_2, VAR(uint8, AUTOMATIC) ApiId, VAR(uint8, AUTOMATIC) ErrorId);
#define DET_STOP_SEC_CODE
#include "DET_MemMap.h"
