...
#define SchM_Enter_FiM_REQUEST_EVENTID_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_FiM_REQUEST_EVENTID_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_FiM_REQUEST_FID_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_FiM_REQUEST_FID_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
