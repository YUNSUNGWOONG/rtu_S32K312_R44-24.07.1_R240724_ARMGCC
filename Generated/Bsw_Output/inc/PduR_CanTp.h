...
extern FUNC(BufReq_ReturnType, PDUR_CODE) PduR_CanTpCopyTxData(PduIdType txPduId,
...
extern FUNC(void, PDUR_CODE) PduR_CanTpRxIndication(PduIdType rxPduId,
Std_ReturnType result);

/* Extern Declaration for PduR_CanTpTxConfirmation() API */
extern FUNC(void, PDUR_CODE) PduR_CanTpTxConfirmation(PduIdType txPduId, Std_ReturnType result);
