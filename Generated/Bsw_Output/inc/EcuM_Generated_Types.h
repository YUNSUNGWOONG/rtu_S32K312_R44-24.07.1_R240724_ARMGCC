...
**                      Include Section                                       **
*******************************************************************************/
/* polyspace<MISRA-C:1.1:Not a defect:Low> Not a defect */
#include "Std_Types.h"
/* polyspace<MISRA-C:1.1:Not a defect:Low> Not a defect */
#include "EcuM_Cfg.h"
/* polyspace<MISRA-C:1.1:Not a defect:Low> Not a defect */
/* @Trace: EcuM_SUD_DATATYPE_001, EcuM_SUD_DATATYPE_002, EcuM_SUD_DATATYPE_003, EcuM_SUD_DATATYPE_004,
   EcuM_SUD_DATATYPE_005, EcuM_SUD_DATATYPE_006, EcuM_SUD_DATATYPE_007, EcuM_SUD_DATATYPE_008,
   EcuM_SUD_DATATYPE_009, EcuM_SUD_DATATYPE_010, EcuM_SUD_DATATYPE_011, EcuM_SUD_DATATYPE_012,
   EcuM_SUD_DATATYPE_013 */
...
typedef struct
{
  ...
  P2CONST (uint32, ECUM_CONST, ECUM_CONST) ptrEcuMConfigConsistencyHash;
  
  /* EcuMDefaultState */
  EcuM_StateType EcuMDefaultState;

  /* EcuMDefaultResetModeRef reference to EcuMResetMode */
  uint8 EcuMDefaultResetMode;

  /* EcuMDefaultSleepModeRef reference to EcuMSleepMode */
  uint8 EcuMDefaultSleepMode;

  /* EcuMDefaultAppMode reference to OsAppMode */
  uint8 EcuMDefaultAppMode;
  
    /* Pointer to BswM config structure */
  P2CONST(void, ECUM_CONST, BSWM_CONST) BswMConfig;

  /* Pointer to SchM config structure */
  P2CONST(void, ECUM_CONST, RTE_CONST) SchMConfig;
...
/* polyspace<MISRA-C:8.12:Not a defect:Low> size of array is determined by configuration */
extern CONST(uint32, ECUM_CONST) EcuM_PBcfgHashValue[];

/* polyspace<MISRA-C:8.12:Not a defect:Low> size of array is determined by configuration */
extern CONST(uint32, ECUM_CONST) EcuM_LcfgHashValue[];
