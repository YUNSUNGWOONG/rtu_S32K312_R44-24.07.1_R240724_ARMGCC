...
extern FUNC(uint8, RTE_CODE) SchM_Mode_BswM_modeNotificationPort_DcmEcuReset(P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) previousMode,P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) nextMode);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_BswM_modeNotificationPort_DcmControlDTCSetting(P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) previousMode,P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) nextMode);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_BswM_modeNotificationPort_DcmDiagnosticSessionControl(P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) previousMode,P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) nextMode);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) SchM_Switch_BswM_modeSwitchPort_CurrentMode(CONST(EcuM_StateType, RTE_APPL_CONST) Data);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_BswM_modeNotificationPort_DcmModeRapidPowerShutDown(P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) previousMode,P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) nextMode);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(uint8, RTE_CODE) SchM_Mode_BswM_modeNotificationPort_DcmCommunicationControl_FD_CAN1(P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) previousMode,P2VAR(uint8, AUTOMATIC, RTE_APPL_DATA) nextMode);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
...
#define SchM_Enter_BswM_RULEPREVRESULT_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_BswM_RULEPREVRESULT_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_BswM_RULESTATUS_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_BswM_RULESTATUS_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_BswM_DATA_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_BswM_DATA_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
...
#define BSWM_START_SEC_CODE
#include "MemMap.h"
FUNC(void, BSWM_CODE) BswM_ActionList_SchMSwitch_CurrentMode(void);
#define BSWM_STOP_SEC_CODE
#include "MemMap.h"
