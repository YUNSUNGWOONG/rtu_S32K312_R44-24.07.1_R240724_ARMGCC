...
#define SchM_Enter_EcuM_SHUTDOWN_OR_SLEEP_FLAG_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_EcuM_SHUTDOWN_OR_SLEEP_FLAG_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_EcuM_WAKEUP_STATUS_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_EcuM_WAKEUP_STATUS_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_EcuM_SHUTDOWN_TARGET_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_EcuM_SHUTDOWN_TARGET_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_EcuM_ALARM_TIME_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_EcuM_ALARM_TIME_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_EcuM_STATE_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_EcuM_STATE_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_EcuM_SHUTDOWN_CAUSE() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_EcuM_SHUTDOWN_CAUSE() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_EcuM_BOOT_TARGET_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_EcuM_BOOT_TARGET_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
