...
/******************************************************************************/
typedef struct Rte_CDS_KeyM Rte_CDS_KeyM;
...
#define RTE_KeyM_START_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
extern CONSTP2CONST(Rte_CDS_KeyM, RTE_CONST, RTE_CONST) Rte_Inst_KeyM;
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_KeyM_STOP_SEC_CONST_ASIL_D_UNSPECIFIED
#include "Rte_MemMap.h"
...
#define KeyM_START_SEC_CODE
#include "KeyM_MemMap.h"
FUNC(Std_ReturnType, KeyM_CODE) KeyM_Update(P2CONST(uint8, AUTOMATIC, RTE_APPL_CONST) KeyNamePtr, VAR(uint16, AUTOMATIC) KeyNameLength, VAR(KeyM_ConstCryptoKeyDataType, AUTOMATIC) RequestDataPtr, VAR(uint16, AUTOMATIC) RequestDataLength, VAR(KeyM_CryptoKeyDataType, AUTOMATIC) ResultDataPtr, VAR(uint16, AUTOMATIC) ResultDataMaxLength);
#define KeyM_STOP_SEC_CODE
#include "KeyM_MemMap.h"
...
#include "Rte_MemMap.h"
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_KeyM_KeyMCryptoKeyNotification_CryptoKeyUpdateCallbackNotification(VAR(KeyM_ResultType, AUTOMATIC) Result,VAR(uint16, AUTOMATIC) ResponseDataLength,VAR(KeyM_CryptoKeyDataType, AUTOMATIC) ResponseData);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
...
#define RTE_E_KeyMCryptoKey_E_OK 0U
