...
#define SchM_Enter_Com_RX_EXT_SIG_DATA_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_RX_EXT_SIG_DATA_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_RX_IPDU_STS_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_RX_IPDU_STS_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_TX_IPDU_BUFFER_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_TX_IPDU_BUFFER_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_RX_GW_STS_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_RX_GW_STS_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_TX_MDT_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_TX_MDT_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_RX_FIFO_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_RX_FIFO_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_RX_IPDU_DATA_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_RX_IPDU_DATA_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_TX_TMS_STATUS_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_TX_TMS_STATUS_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_IPDU_COUNTER_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_IPDU_COUNTER_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_TX_IPDU_DATA_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_TX_IPDU_DATA_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_TX_EXT_SIG_DATA_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_TX_EXT_SIG_DATA_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_TX_IPDU_STATUS_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_TX_IPDU_STATUS_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_RX_DM_STS_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_RX_DM_STS_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_SIG_DATA_PROTECTION_AREA() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_SIG_DATA_PROTECTION_AREA() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Com_IPDU_GROUP_STATUS_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Com_IPDU_GROUP_STATUS_PROTECTION() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
