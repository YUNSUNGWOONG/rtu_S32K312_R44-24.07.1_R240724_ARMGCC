...
extern FUNC(void, PDUR_CODE) PduR_CanNmTxConfirmation(PduIdType txPduId,
Std_ReturnType result);

/* Extern Declaration for PduR_CanNmTriggerTransmit() API */
extern FUNC(Std_ReturnType, PDUR_CODE) PduR_CanNmTriggerTransmit(PduIdType txPduId,
P2VAR(PduInfoType, AUTOMATIC, PDUR_CONST) ptrPduInfoPtr);

/* Extern Declaration for PduR_CanNmRxIndication() API */
extern FUNC(void, PDUR_CODE) PduR_CanNmRxIndication(PduIdType rxPduId,
