...
/******************************************************************************/
#ifndef SCHM_LINTRCV_H
#define SCHM_LINTRCV_H

/******************************************************************************/
/*                              Header Inclusion                              */
/******************************************************************************/
#include "SchM_LinTrcv_Type.h"
#include "Rte.h"
#include "Os.h"
...
#define SchM_Enter_LinTrcv_DIO_READ_WRITE_PROTECTION() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_LinTrcv_DIO_READ_WRITE_PROTECTION() do {\
 \
