...
extern FUNC(void, RTE_CODE) Rte_MemCpy(P2VAR(void, AUTOMATIC, RTE_DATA) Lpt_dst, P2CONST(void, AUTOMATIC, RTE_DATA) Lpt_src, CONST(uint32, RTE_DATA) Lu32_Size);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
...
#define RTE_COMMON_START_SEC_CODE_ASIL_D
#include "Rte_MemMap.h"
extern FUNC(void, RTE_CODE) Rte_MemSet(P2VAR(void, AUTOMATIC, RTE_DATA) Lpt_dst, VAR(uint8, RTE_VAR) Data, CONST(uint32, RTE_DATA) Lu32_Size);
/*LDRA_INSPECTED 580 S ; Source: MISRA:2012 R.1.1,R.20.4 */
/*LDRA_INSPECTED 628 S ; Source: MISRA:2012 R.2.5 */
/*LDRA_INSPECTED 338 S ; Source: MISRA:2012 R.20.1 */
#define RTE_COMMON_STOP_SEC_CODE_ASIL_D
