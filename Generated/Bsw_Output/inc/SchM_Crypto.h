...
#define SchM_Enter_Crypto_CRYPTO_EXCLUSIVE_AREA_10() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Crypto_CRYPTO_EXCLUSIVE_AREA_10() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Crypto_CRYPTO_EXCLUSIVE_AREA_04() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Crypto_CRYPTO_EXCLUSIVE_AREA_04() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Crypto_CRYPTO_EXCLUSIVE_AREA_02() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Crypto_CRYPTO_EXCLUSIVE_AREA_02() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Crypto_CRYPTO_EXCLUSIVE_AREA_00() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Crypto_CRYPTO_EXCLUSIVE_AREA_00() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Crypto_CRYPTO_EXCLUSIVE_AREA_11() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Crypto_CRYPTO_EXCLUSIVE_AREA_11() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Crypto_CRYPTO_EXCLUSIVE_AREA_05() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Crypto_CRYPTO_EXCLUSIVE_AREA_05() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Crypto_CRYPTO_EXCLUSIVE_AREA_03() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Crypto_CRYPTO_EXCLUSIVE_AREA_03() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
#define SchM_Enter_Crypto_CRYPTO_EXCLUSIVE_AREA_01() do {\
 \
  (void) SuspendAllInterrupts(); \
} while(0);

#define SchM_Exit_Crypto_CRYPTO_EXCLUSIVE_AREA_01() do {\
 \
  (void) ResumeAllInterrupts(); \
} while(0);
