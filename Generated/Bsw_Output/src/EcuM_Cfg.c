...
/* Array for Core ID 
 * Master Core : EcuM_CoreID[0] * Slave Cores : EcuM_CoreID[1] ~ */
/*CONST(CoreIdType, ECUM_CONST) EcuM_CoreID[ECUM_NO_OF_CORES] = {
};*/

/* Reference to EcuMFlexUserConfig from EcuMGoDownAllowedUserRef */
CONST(uint8, ECUM_CONST) EcuM_GoDownAllowedUser[ECUM_NO_OF_GODOWNUSERS] = {
  42,  255,  254
};

/* Reference to EcuMOSResource from EcuMCommonConfiguration container */
CONST(ResourceType, ECUM_CONST) EcuM_OsResources[ECUM_NO_OF_OSRESOURCES] = {
  OsResource_BG
};

/* Array for ResetMode */
CONST(uint8, ECUM_CONST) EcuM_ResetModeId[ECUM_NO_OF_RESETMODES] = {
  0,  1,  2,  3,  4,  5
};

/* Reference to EcuMFlexUserConfig from EcuMSetClockAllowedUserRef */
 /* @Trace: EcuM_SUD_GENERATION_006 */
CONST(uint8, ECUM_CONST) EcuM_SetClockAllowedUser[ECUM_NO_OF_CLOCKUSERS] = {
  255
};

/* Array for ShutdownCause */
CONST(uint8, ECUM_CONST) EcuM_ShutdownCauseId[ECUM_NO_OF_SHUTDOWNCAUSE] = {
  0,  1,  2,  3,  4
};

/* Reference to OsTask container through OsTaskRef in EcuMFlexConfiguration container */
/*CONST(TaskType, ECUM_CONST) EcuM_OsTask[ECUM_NO_OF_OS_TASKS] = {
};*/

/* Reference to OsEvent container through OsTaskEventRef in OsTask container  */
/*CONST(EventMaskType, ECUM_CONST) EcuM_EventMask[ECUM_NO_OF_EVENT_MASKS] = {
};*/

/* Array for number of Pnc Id in a EcuMWakeupSource */
CONST(uint8, ECUM_CONST) EcuM_WakeupPncIndex[ECUM_NO_OF_WAKEUPSOURCES] = {
  0,  0,  0,  0,  0,  0,  0,  0,  0
};

/* Global array for Hash Value configured in the consistency hash parameter */
CONST(uint32, ECUM_CONST) EcuM_LcfgHashValue[ECUM_NO_OF_HASH_SEGMENTS] = {
  0x00000001, 0x23456789
};


/* Structure for EcuMAlarmClock */
/* @Trace: EcuM_SUD_GENERATION_002 EcuM_SUD_GENERATION_056 EcuM_SUD_GENERATION_053 */
/*CONST(EcuM_AlarmClockType, ECUM_CONST) EcuM_AlarmClock[ECUM_NO_OF_ALARMS] =
*/

/* Structure for EcuMSleepMode */
/* @Trace: EcuM_SUD_GENERATION_009 */
CONST(EcuM_SleepModeConfigType, ECUM_CONST) EcuM_SleepModes[ECUM_NO_OF_SLEEPMODES] =
{
  /* SleepModes 0 - 1 */
  {
    /* WakeupSourceMask */
...
/* @Trace: EcuM_SUD_GENERATION_010 */
CONST(EcuM_WakeupSourceConfigType, ECUM_CONST) EcuM_WakeupSource[ECUM_NO_OF_WAKEUPSOURCES] =
{
  /* WakeupSources 0 - 1 */
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[0],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[0],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[0],
  ...
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[1],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[1],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[1],
  ...
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[2],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[2],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[2],
  ...
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[3],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[3],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[3],
  ...
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[4],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[4],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[4],
  ...
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[5],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[5],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[5],
  ...
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[6],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[6],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[6],
  ...
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[7],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[7],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[7],
  ...
  {
    /* *ptrEcuMWakeupCounter */
    &EcuM_WakeupCounter[8],

    /* *ptrEcuMWakeupStatus */
    &EcuM_WakeupStatus[8],

    /* *ptrEcuMCheckWakeupCounter */
    &EcuM_CheckWakeupCounter[8],
...
/* @Trace: EcuM_SUD_GENERATION_008 */
/* Structure for EcuM Users */
CONST(EcuM_FlexUserType, ECUM_CONST) EcuM_FlexUsers[ECUM_NO_OF_USERS] =
{
  /* Users 0 - 1 */
  {
    /* User */
    ...
    /* CoreId */
    (CoreIdType)ECUM_CORE_ID_INVALID
  },
  /* Users 1 - 2 */
  {
    /* User */
