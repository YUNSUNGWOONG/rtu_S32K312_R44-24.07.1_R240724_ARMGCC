...
CONST(uint32, ECUM_CONST) EcuM_PBcfgHashValue[ECUM_NO_OF_HASH_SEGMENTS] = {
...
/* Config structure Variant_FL - 0 */
/* @Trace: EcuM_SUD_GENERATION_020 */
CONST(EcuM_ConfigType, ECUM_CONST) EcuM_Config_Variant_FL =
{
  /* *ptrEcuMConfigConsistencyHash */
  &EcuM_PBcfgHashValue[0],
  /* EcuMDefaultState */
  ECUM_SHUTDOWN_TARGET_SLEEP,
  /* EcuMDefaultResetMode */
  ECUM_RESET_MCU,
