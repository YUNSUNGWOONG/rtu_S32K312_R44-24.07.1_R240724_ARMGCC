...
*******************************************************************************/
/* polyspace MISRA-C3:5.1 [No action planned:Low] "External function is difined for same API with different dataset which is used as postfix" */
/* polyspace-begin MISRA-C3:20.1 [Justified:Low] "see SWS_MemMap_00003 of AUTOSAR" */
/* polyspace-begin MISRA-C3:17.8 [Justified:Low] "The function just point to const address of input parameter so  no impact of this rule violation" */
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Ioc.h"
...
/* polyspace-end MISRA-C3:17.8 [Justified:Low] "The function just point to const address of input parameter so  no impact of this rule violation" */
/*******************************************************************************
**                      End of File                                           **
*******************************************************************************/
