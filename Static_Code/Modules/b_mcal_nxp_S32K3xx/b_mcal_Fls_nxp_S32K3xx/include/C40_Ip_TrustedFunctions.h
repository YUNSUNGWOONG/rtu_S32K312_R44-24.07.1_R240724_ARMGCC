...
#if (C40_IP_TYPES_VENDOR_ID_CFG != C40_IP_TRUSTEDFUNCTIONS_VENDOR_ID_H)
    #error "C40_Ip_TrustedFunctions.h and C40_Ip_Types.h have different vendor ids"
#endif
/* Check if current file and C40_Ip_Types header file are of the same Autosar version */
#if ((C40_IP_TYPES_AR_RELEASE_MAJOR_VERSION_CFG    != C40_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION_H) || \
     (C40_IP_TYPES_AR_RELEASE_MINOR_VERSION_CFG    != C40_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION_H) || \
     (C40_IP_TYPES_AR_RELEASE_REVISION_VERSION_CFG != C40_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION_H) \
    )
    #error "AutoSar Version Numbers of C40_Ip_TrustedFunctions.h and C40_Ip_Types.h are different"
#endif
/* Check if current file and C40_Ip_Types header file are of the same Software version */
#if ((C40_IP_TYPES_SW_MAJOR_VERSION_CFG != C40_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION_H) || \
     (C40_IP_TYPES_SW_MINOR_VERSION_CFG != C40_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION_H) || \
     (C40_IP_TYPES_SW_PATCH_VERSION_CFG != C40_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION_H) \
    )
    #error "Software Version Numbers of C40_Ip_TrustedFunctions.h and C40_Ip_Types.h are different"
#endif

/* Check if current file and C40_Ip_Cfg header file are of the same vendor */
#if (FLS_C40_IP_VENDOR_ID_CFG != C40_IP_TRUSTEDFUNCTIONS_VENDOR_ID_H)
...
#if ((FLS_C40_IP_AR_RELEASE_MAJOR_VERSION_CFG    != C40_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MAJOR_VERSION_H) || \
     (FLS_C40_IP_AR_RELEASE_MINOR_VERSION_CFG    != C40_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION_H) || \
     (FLS_C40_IP_AR_RELEASE_REVISION_VERSION_CFG != C40_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((FLS_C40_IP_SW_MAJOR_VERSION_CFG != C40_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION_H) || \
     (FLS_C40_IP_SW_MINOR_VERSION_CFG != C40_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION_H) || \
     (FLS_C40_IP_SW_PATCH_VERSION_CFG != C40_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION_H) \
    )
