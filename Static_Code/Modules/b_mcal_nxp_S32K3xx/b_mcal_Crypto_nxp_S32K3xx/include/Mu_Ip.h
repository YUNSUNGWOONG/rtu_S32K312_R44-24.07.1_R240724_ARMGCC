...
/* Check if Mu_Ip header file and Hse_Ip_Cfg header file are of the same Autosar version */
#if ((MU_IP_AR_RELEASE_MAJOR_VERSION_H != HSE_IP_CFG_AR_RELEASE_MAJOR_VERSION_H) || \
     (MU_IP_AR_RELEASE_MINOR_VERSION_H != HSE_IP_CFG_AR_RELEASE_MINOR_VERSION_H)    \
    )
    #error "AutoSar Version Numbers of Mu_Ip.h and Hse_Ip_Cfg.h are different"
#endif
