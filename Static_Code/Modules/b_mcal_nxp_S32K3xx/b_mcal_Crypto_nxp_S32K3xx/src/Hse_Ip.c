...
/* Check if Hse_Ip source file and Hse_Ip header file are of the same Autosar version */
#if ((HSE_IP_AR_RELEASE_MAJOR_VERSION_C    != HSE_IP_AR_RELEASE_MAJOR_VERSION_H) || \
     (HSE_IP_AR_RELEASE_MINOR_VERSION_C    != HSE_IP_AR_RELEASE_MINOR_VERSION_H)    \
    )
    #error "AutoSar Version Numbers of Hse_Ip.c and Hse_Ip.h are different"
#endif
...
/* Check if Hse_Ip source file and Mu_Ip header file are of the same Autosar version */
#if ((HSE_IP_AR_RELEASE_MAJOR_VERSION_C != MU_IP_AR_RELEASE_MAJOR_VERSION_H) || \
     (HSE_IP_AR_RELEASE_MINOR_VERSION_C != MU_IP_AR_RELEASE_MINOR_VERSION_H)    \
    )
    #error "AutoSar Version Numbers of Hse_Ip.c and Mu_Ip.h are different"
#endif
