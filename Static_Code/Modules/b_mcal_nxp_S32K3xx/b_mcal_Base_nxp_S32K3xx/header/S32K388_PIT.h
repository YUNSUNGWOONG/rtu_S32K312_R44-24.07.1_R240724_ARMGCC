...
typedef struct {
  ...
  __I  uint32_t LTMR64H;                           /**< PIT Upper Lifetime Timer, offset: 0xE0, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
  __I  uint32_t LTMR64L;                           /**< PIT Lower Lifetime Timer, offset: 0xE4, available only on: PIT_0 (missing on PIT_1, PIT_2, PIT_3) */
