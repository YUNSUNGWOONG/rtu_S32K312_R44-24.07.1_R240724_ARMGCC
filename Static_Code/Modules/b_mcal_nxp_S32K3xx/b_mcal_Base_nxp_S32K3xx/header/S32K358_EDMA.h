 ...
 * @version 1.1
 * @date 2022-10-01
 * @brief Peripheral Access Layer for S32K358_eDMA
 *
...
#if !defined(S32K358_eDMA_H_)  /* Check if memory map has not been already included */
#define S32K358_eDMA_H_
...
#endif  /* #if !defined(S32K358_eDMA_H_) */
