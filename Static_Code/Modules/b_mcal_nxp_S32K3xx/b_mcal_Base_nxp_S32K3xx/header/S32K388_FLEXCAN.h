...
typedef struct {
  ...
  __IO uint32_t IMASK3;                            /**< Interrupt Masks 3 Register, offset: 0x6C, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  uint8_t RESERVED_3[4];
  __IO uint32_t IFLAG3;                            /**< Interrupt Flags 3 Register, offset: 0x74, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  ...
  __IO uint32_t ERFCR;                             /**< Enhanced Rx FIFO Control Register, offset: 0xC0C, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  __IO uint32_t ERFIER;                            /**< Enhanced Rx FIFO Interrupt Enable Register, offset: 0xC10, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
  __IO uint32_t ERFSR;                             /**< Enhanced Rx FIFO Status Register, offset: 0xC14, available only on: CAN_0, CAN_1, CAN_2 (missing on CAN_3, CAN_4, CAN_5, CAN_6, CAN_7) */
