 ...
 * @version 1.2
 * @date 2023-01-10
 * @brief Peripheral Access Layer for S32K311_eDMA
 *
...
#if !defined(S32K311_eDMA_H_)  /* Check if memory map has not been already included */
#define S32K311_eDMA_H_
...
#endif  /* #if !defined(S32K311_eDMA_H_) */
