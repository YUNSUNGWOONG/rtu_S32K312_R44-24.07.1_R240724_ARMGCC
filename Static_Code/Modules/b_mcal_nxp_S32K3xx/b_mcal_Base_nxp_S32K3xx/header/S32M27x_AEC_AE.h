...
typedef struct {
  ...
  __IO uint16_t LINPHY_MONITOR;                    /**< LINPHY Monitor, offset: 0x64 */
  uint8_t RESERVED_14[10];
...
#define AEC_AE_CLKGEN_CFG_CLKGEN_CFG_MASK        (0x1FFU)
#define AEC_AE_CLKGEN_CFG_CLKGEN_CFG_SHIFT       (0U)
#define AEC_AE_CLKGEN_CFG_CLKGEN_CFG_WIDTH       (9U)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_FL(x)  (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_FL_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_FL_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_FL(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_FL_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_FL_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_FL(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_FL_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_FL_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_FL(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_FL_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_FL_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_MON(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_MON_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_MON_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_MON(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_MON_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_MON_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_MON(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_MON_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_MON_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_MON(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_MON_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_MON_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_EN(x)  (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_EN_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_WKUP_EN_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_EN(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_EN_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_SCPSTATE_EN_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_EN(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_EN_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_TXTOSTATE_EN_MASK)
...
#define AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_EN(x) (((uint16_t)(((uint16_t)(x)) << AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_EN_SHIFT)) & AEC_AE_LINPHY_MONITOR_LINPHY_ERROR_EN_MASK)
/*! @} */
