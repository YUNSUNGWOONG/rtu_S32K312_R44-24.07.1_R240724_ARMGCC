...
typedef struct {
  __IO uint32_t PFCR[PFLASH_PFCRI_COUNT];          /**< Platform Flash Memory Configuration 0, array offset: 0x0, array step: 0x4 */
...
/*! @name PFCR - Platform Flash Memory Configuration 0 */
/*! @{ */
