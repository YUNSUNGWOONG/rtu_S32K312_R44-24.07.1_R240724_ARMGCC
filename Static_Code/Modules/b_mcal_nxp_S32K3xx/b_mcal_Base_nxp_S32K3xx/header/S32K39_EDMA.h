 ...
 * @version 1.7
 * @date 2022-11-18
 * @brief Peripheral Access Layer for S32K39_eDMA
 *
...
#if !defined(S32K39_eDMA_H_)  /* Check if memory map has not been already included */
#define S32K39_eDMA_H_
...
#endif  /* #if !defined(S32K39_eDMA_H_) */
