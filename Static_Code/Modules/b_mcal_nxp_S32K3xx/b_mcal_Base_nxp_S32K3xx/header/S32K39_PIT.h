...
typedef struct {
  ...
  __I  uint32_t LTMR64H;                           /**< PIT Upper Lifetime Timer, offset: 0xE0 */
  __I  uint32_t LTMR64L;                           /**< PIT Lower Lifetime Timer, offset: 0xE4 */
  uint8_t RESERVED_1[4];
  __IO uint32_t RTI_LDVAL_STAT;                    /**< RTI Timer Load Value Sync Status, offset: 0xEC */
  __IO uint32_t RTI_LDVAL;                         /**< RTI Timer Load Value, offset: 0xF0 */
  __I  uint32_t RTI_CVAL;                          /**< Current RTI Timer Value, offset: 0xF4 */
  __IO uint32_t RTI_TCTRL;                         /**< RTI Timer Control, offset: 0xF8 */
  __IO uint32_t RTI_TFLG;                          /**< RTI Timer Interrupt Flag, offset: 0xFC */
...
/*! @name LTMR64H - PIT Upper Lifetime Timer */
/*! @{ */
...
/*! @name LTMR64L - PIT Lower Lifetime Timer */
/*! @{ */
