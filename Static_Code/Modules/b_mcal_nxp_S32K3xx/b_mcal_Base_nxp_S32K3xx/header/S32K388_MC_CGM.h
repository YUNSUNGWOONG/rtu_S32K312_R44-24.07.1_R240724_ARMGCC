...
typedef struct {
  ...
  __IO uint32_t MUX_17_CSC;                        /**< Clock Mux 17 Select Control Register, offset: 0x740 */
  __I  uint32_t MUX_17_CSS;                        /**< Clock Mux 17 Select Status Register, offset: 0x744 */
  __IO uint32_t MUX_17_DC_0;                       /**< Clock Mux 17 Divider 0 Control Register, offset: 0x748 */
  uint8_t RESERVED_19[48];
  __I  uint32_t MUX_17_DIV_UPD_STAT;               /**< Clock Mux 17 Divider Update Status Register, offset: 0x77C */
...
/*! @name MUX_17_CSC - Clock Mux 17 Select Control Register */
/*! @{ */

#define MC_CGM_MUX_17_CSC_CLK_SW_MASK            (0x4U)
#define MC_CGM_MUX_17_CSC_CLK_SW_SHIFT           (2U)
#define MC_CGM_MUX_17_CSC_CLK_SW_WIDTH           (1U)
#define MC_CGM_MUX_17_CSC_CLK_SW(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_CSC_CLK_SW_SHIFT)) & MC_CGM_MUX_17_CSC_CLK_SW_MASK)

#define MC_CGM_MUX_17_CSC_SAFE_SW_MASK           (0x8U)
#define MC_CGM_MUX_17_CSC_SAFE_SW_SHIFT          (3U)
#define MC_CGM_MUX_17_CSC_SAFE_SW_WIDTH          (1U)
#define MC_CGM_MUX_17_CSC_SAFE_SW(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_CSC_SAFE_SW_SHIFT)) & MC_CGM_MUX_17_CSC_SAFE_SW_MASK)

#define MC_CGM_MUX_17_CSC_SELCTL_MASK            (0xF000000U)
#define MC_CGM_MUX_17_CSC_SELCTL_SHIFT           (24U)
#define MC_CGM_MUX_17_CSC_SELCTL_WIDTH           (4U)
#define MC_CGM_MUX_17_CSC_SELCTL(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_CSC_SELCTL_SHIFT)) & MC_CGM_MUX_17_CSC_SELCTL_MASK)
/*! @} */

/*! @name MUX_17_CSS - Clock Mux 17 Select Status Register */
/*! @{ */

#define MC_CGM_MUX_17_CSS_CLK_SW_MASK            (0x4U)
#define MC_CGM_MUX_17_CSS_CLK_SW_SHIFT           (2U)
#define MC_CGM_MUX_17_CSS_CLK_SW_WIDTH           (1U)
#define MC_CGM_MUX_17_CSS_CLK_SW(x)              (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_CSS_CLK_SW_SHIFT)) & MC_CGM_MUX_17_CSS_CLK_SW_MASK)

#define MC_CGM_MUX_17_CSS_SAFE_SW_MASK           (0x8U)
#define MC_CGM_MUX_17_CSS_SAFE_SW_SHIFT          (3U)
#define MC_CGM_MUX_17_CSS_SAFE_SW_WIDTH          (1U)
#define MC_CGM_MUX_17_CSS_SAFE_SW(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_CSS_SAFE_SW_SHIFT)) & MC_CGM_MUX_17_CSS_SAFE_SW_MASK)

#define MC_CGM_MUX_17_CSS_SWIP_MASK              (0x10000U)
#define MC_CGM_MUX_17_CSS_SWIP_SHIFT             (16U)
#define MC_CGM_MUX_17_CSS_SWIP_WIDTH             (1U)
#define MC_CGM_MUX_17_CSS_SWIP(x)                (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_CSS_SWIP_SHIFT)) & MC_CGM_MUX_17_CSS_SWIP_MASK)

#define MC_CGM_MUX_17_CSS_SWTRG_MASK             (0xE0000U)
#define MC_CGM_MUX_17_CSS_SWTRG_SHIFT            (17U)
#define MC_CGM_MUX_17_CSS_SWTRG_WIDTH            (3U)
#define MC_CGM_MUX_17_CSS_SWTRG(x)               (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_CSS_SWTRG_SHIFT)) & MC_CGM_MUX_17_CSS_SWTRG_MASK)

#define MC_CGM_MUX_17_CSS_SELSTAT_MASK           (0xF000000U)
#define MC_CGM_MUX_17_CSS_SELSTAT_SHIFT          (24U)
#define MC_CGM_MUX_17_CSS_SELSTAT_WIDTH          (4U)
#define MC_CGM_MUX_17_CSS_SELSTAT(x)             (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_CSS_SELSTAT_SHIFT)) & MC_CGM_MUX_17_CSS_SELSTAT_MASK)
/*! @} */

/*! @name MUX_17_DC_0 - Clock Mux 17 Divider 0 Control Register */
/*! @{ */

#define MC_CGM_MUX_17_DC_0_DIV_MASK              (0x3F0000U)
#define MC_CGM_MUX_17_DC_0_DIV_SHIFT             (16U)
#define MC_CGM_MUX_17_DC_0_DIV_WIDTH             (6U)
#define MC_CGM_MUX_17_DC_0_DIV(x)                (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_DC_0_DIV_SHIFT)) & MC_CGM_MUX_17_DC_0_DIV_MASK)

#define MC_CGM_MUX_17_DC_0_DE_MASK               (0x80000000U)
#define MC_CGM_MUX_17_DC_0_DE_SHIFT              (31U)
#define MC_CGM_MUX_17_DC_0_DE_WIDTH              (1U)
#define MC_CGM_MUX_17_DC_0_DE(x)                 (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_DC_0_DE_SHIFT)) & MC_CGM_MUX_17_DC_0_DE_MASK)
/*! @} */

/*! @name MUX_17_DIV_UPD_STAT - Clock Mux 17 Divider Update Status Register */
/*! @{ */

#define MC_CGM_MUX_17_DIV_UPD_STAT_DIV_STAT_MASK (0x1U)
#define MC_CGM_MUX_17_DIV_UPD_STAT_DIV_STAT_SHIFT (0U)
#define MC_CGM_MUX_17_DIV_UPD_STAT_DIV_STAT_WIDTH (1U)
#define MC_CGM_MUX_17_DIV_UPD_STAT_DIV_STAT(x)   (((uint32_t)(((uint32_t)(x)) << MC_CGM_MUX_17_DIV_UPD_STAT_DIV_STAT_SHIFT)) & MC_CGM_MUX_17_DIV_UPD_STAT_DIV_STAT_MASK)
/*! @} */
