...
typedef struct {
  ...
  __IO uint32_t DCMRWD17;                          /**< Read Write GPR On Destructive Reset 17, offset: 0x540 */
       uint32_t DCMRWD18;                          /**< Read Write GPR On Destructive Reset 18, offset: 0x544 */
...
#define DCM_GPR_DCMROD8_EMAC2_GSKT_ALARM_MASK    (0x200U)
#define DCM_GPR_DCMROD8_EMAC2_GSKT_ALARM_SHIFT   (9U)
#define DCM_GPR_DCMROD8_EMAC2_GSKT_ALARM_WIDTH   (1U)
#define DCM_GPR_DCMROD8_EMAC2_GSKT_ALARM(x)      (((uint32_t)(((uint32_t)(x)) << DCM_GPR_DCMROD8_EMAC2_GSKT_ALARM_SHIFT)) & DCM_GPR_DCMROD8_EMAC2_GSKT_ALARM_MASK)

#define DCM_GPR_DCMROD8_EMAC2_RDATA_EDC_ERR_MASK (0x400U)
#define DCM_GPR_DCMROD8_EMAC2_RDATA_EDC_ERR_SHIFT (10U)
#define DCM_GPR_DCMROD8_EMAC2_RDATA_EDC_ERR_WIDTH (1U)
#define DCM_GPR_DCMROD8_EMAC2_RDATA_EDC_ERR(x)   (((uint32_t)(((uint32_t)(x)) << DCM_GPR_DCMROD8_EMAC2_RDATA_EDC_ERR_SHIFT)) & DCM_GPR_DCMROD8_EMAC2_RDATA_EDC_ERR_MASK)
...
#define DCM_GPR_DCMRWD16_EMAC2_GSKT_ALARM_EN_MASK (0x200U)
#define DCM_GPR_DCMRWD16_EMAC2_GSKT_ALARM_EN_SHIFT (9U)
#define DCM_GPR_DCMRWD16_EMAC2_GSKT_ALARM_EN_WIDTH (1U)
#define DCM_GPR_DCMRWD16_EMAC2_GSKT_ALARM_EN(x)  (((uint32_t)(((uint32_t)(x)) << DCM_GPR_DCMRWD16_EMAC2_GSKT_ALARM_EN_SHIFT)) & DCM_GPR_DCMRWD16_EMAC2_GSKT_ALARM_EN_MASK)

#define DCM_GPR_DCMRWD16_EMAC2_RDATA_EDC_ERR_EN_MASK (0x400U)
#define DCM_GPR_DCMRWD16_EMAC2_RDATA_EDC_ERR_EN_SHIFT (10U)
#define DCM_GPR_DCMRWD16_EMAC2_RDATA_EDC_ERR_EN_WIDTH (1U)
#define DCM_GPR_DCMRWD16_EMAC2_RDATA_EDC_ERR_EN(x) (((uint32_t)(((uint32_t)(x)) << DCM_GPR_DCMRWD16_EMAC2_RDATA_EDC_ERR_EN_SHIFT)) & DCM_GPR_DCMRWD16_EMAC2_RDATA_EDC_ERR_EN_MASK)
...
#define DCM_GPR_DCMRWF1_EMAC_TX_RMII_CLK_LPBCK_EN_MASK (0x80000000U)
#define DCM_GPR_DCMRWF1_EMAC_TX_RMII_CLK_LPBCK_EN_SHIFT (31U)
#define DCM_GPR_DCMRWF1_EMAC_TX_RMII_CLK_LPBCK_EN_WIDTH (1U)
#define DCM_GPR_DCMRWF1_EMAC_TX_RMII_CLK_LPBCK_EN(x) (((uint32_t)(((uint32_t)(x)) << DCM_GPR_DCMRWF1_EMAC_TX_RMII_CLK_LPBCK_EN_SHIFT)) & DCM_GPR_DCMRWF1_EMAC_TX_RMII_CLK_LPBCK_EN_MASK)
/*! @} */
...
#define DCM_GPR_DCMRWF3_MAC_RX_CLK_MUX_BYPASS_MASK (0x2000U)
#define DCM_GPR_DCMRWF3_MAC_RX_CLK_MUX_BYPASS_SHIFT (13U)
#define DCM_GPR_DCMRWF3_MAC_RX_CLK_MUX_BYPASS_WIDTH (1U)
...
#define DCM_GPR_DCMRWF4_EMAC_SB_END_CTRL_MASK    (0x800000U)
#define DCM_GPR_DCMRWF4_EMAC_SB_END_CTRL_SHIFT   (23U)
#define DCM_GPR_DCMRWF4_EMAC_SB_END_CTRL_WIDTH   (1U)
#define DCM_GPR_DCMRWF4_EMAC_SB_END_CTRL(x)      (((uint32_t)(((uint32_t)(x)) << DCM_GPR_DCMRWF4_EMAC_SB_END_CTRL_SHIFT)) & DCM_GPR_DCMRWF4_EMAC_SB_END_CTRL_MASK)

#define DCM_GPR_DCMRWF4_EMAC2_CONF_SEL_MASK      (0x3000000U)
#define DCM_GPR_DCMRWF4_EMAC2_CONF_SEL_SHIFT     (24U)
#define DCM_GPR_DCMRWF4_EMAC2_CONF_SEL_WIDTH     (2U)
#define DCM_GPR_DCMRWF4_EMAC2_CONF_SEL(x)        (((uint32_t)(((uint32_t)(x)) << DCM_GPR_DCMRWF4_EMAC2_CONF_SEL_SHIFT)) & DCM_GPR_DCMRWF4_EMAC2_CONF_SEL_MASK)
...
#define DCM_GPR_DCMRWF4_MAC2_RX_CLK_MUX_BYPASS_MASK (0x20000000U)
#define DCM_GPR_DCMRWF4_MAC2_RX_CLK_MUX_BYPASS_SHIFT (29U)
#define DCM_GPR_DCMRWF4_MAC2_RX_CLK_MUX_BYPASS_WIDTH (1U)
