...
typedef struct {
  ...
  __IO uint32_t ERFCR;                             /**< Enhanced Rx FIFO Control Register, offset: 0xC0C, available only on: CAN_0 (missing on CAN_1, CAN_2) */
  __IO uint32_t ERFIER;                            /**< Enhanced Rx FIFO Interrupt Enable Register, offset: 0xC10, available only on: CAN_0 (missing on CAN_1, CAN_2) */
  __IO uint32_t ERFSR;                             /**< Enhanced Rx FIFO Status Register, offset: 0xC14, available only on: CAN_0 (missing on CAN_1, CAN_2) */
