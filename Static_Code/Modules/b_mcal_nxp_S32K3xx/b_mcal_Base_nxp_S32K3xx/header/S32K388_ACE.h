...
typedef struct {
  __O  uint64_t INIT_VEC;                          /**< offset: 0x0, available only on: ACE.AHB/ACE__AHB (missing on ACE.AHB2/ACE__AHB2) */
  __O  uint64_t DATA_IN;                           /**< offset: 0x8, available only on: ACE.AHB/ACE__AHB (missing on ACE.AHB2/ACE__AHB2) */
  uint8_t RESERVED_0[240];
  __I  uint64_t STATUS;                            /**< offset: 0x100, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
  __IO uint64_t CONTROL;                           /**< offset: 0x108, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
  uint8_t RESERVED_1[8];
  __IO uint64_t RESULT;                            /**< offset: 0x118, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
  __IO uint64_t AUTH_TAG;                          /**< offset: 0x120, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
  __I  uint64_t VERSION;                           /**< offset: 0x128, available only on: ACE.AHB2/ACE__AHB2 (missing on ACE.AHB/ACE__AHB) */
