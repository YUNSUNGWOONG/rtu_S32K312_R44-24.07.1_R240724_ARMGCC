...
typedef struct {
  ...
  __IO uint32_t MSCR[SIUL2_MSCR_COUNT];            /**< SIUL2 Multiplexed Signal Configuration, array offset: 0x240, array step: 0x4, valid indices: [0-17, 32-37, 40-49, 64-81, 96-113, 128-131, 134-141, 143-144] */
