...
typedef struct {
  ...
  __IO uint16_t MIRR_ADDR;                         /**< Mirror Address, offset: 0x4 */
  __IO uint16_t DATAIN;                            /**< Data Input, offset: 0x6 */
...
/*! @name MIRR_ADDR - Mirror Address */
/*! @{ */

#define MEM_OTP_AE_MIRR_ADDR_MIRADDR_MASK        (0xFFU)
#define MEM_OTP_AE_MIRR_ADDR_MIRADDR_SHIFT       (0U)
#define MEM_OTP_AE_MIRR_ADDR_MIRADDR_WIDTH       (8U)
#define MEM_OTP_AE_MIRR_ADDR_MIRADDR(x)          (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_MIRR_ADDR_MIRADDR_SHIFT)) & MEM_OTP_AE_MIRR_ADDR_MIRADDR_MASK)
/*! @} */

/*! @name DATAIN - Data Input */
/*! @{ */

#define MEM_OTP_AE_DATAIN_INPUT_MASK             (0xFFU)
#define MEM_OTP_AE_DATAIN_INPUT_SHIFT            (0U)
#define MEM_OTP_AE_DATAIN_INPUT_WIDTH            (8U)
#define MEM_OTP_AE_DATAIN_INPUT(x)               (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_DATAIN_INPUT_SHIFT)) & MEM_OTP_AE_DATAIN_INPUT_MASK)

#define MEM_OTP_AE_DATAIN_MIRWR_MASK             (0xFF00U)
#define MEM_OTP_AE_DATAIN_MIRWR_SHIFT            (8U)
#define MEM_OTP_AE_DATAIN_MIRWR_WIDTH            (8U)
#define MEM_OTP_AE_DATAIN_MIRWR(x)               (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_DATAIN_MIRWR_SHIFT)) & MEM_OTP_AE_DATAIN_MIRWR_MASK)
/*! @} */
...
#define MEM_OTP_AE_ERROR_PGMERR_MASK             (0x800U)
#define MEM_OTP_AE_ERROR_PGMERR_SHIFT            (11U)
#define MEM_OTP_AE_ERROR_PGMERR_WIDTH            (1U)
#define MEM_OTP_AE_ERROR_PGMERR(x)               (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_ERROR_PGMERR_SHIFT)) & MEM_OTP_AE_ERROR_PGMERR_MASK)

#define MEM_OTP_AE_ERROR_VRRERR_MASK             (0x1000U)
#define MEM_OTP_AE_ERROR_VRRERR_SHIFT            (12U)
#define MEM_OTP_AE_ERROR_VRRERR_WIDTH            (1U)
#define MEM_OTP_AE_ERROR_VRRERR(x)               (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_ERROR_VRRERR_SHIFT)) & MEM_OTP_AE_ERROR_VRRERR_MASK)

#define MEM_OTP_AE_ERROR_PGMWPERR_MASK           (0x2000U)
#define MEM_OTP_AE_ERROR_PGMWPERR_SHIFT          (13U)
#define MEM_OTP_AE_ERROR_PGMWPERR_WIDTH          (1U)
#define MEM_OTP_AE_ERROR_PGMWPERR(x)             (((uint16_t)(((uint16_t)(x)) << MEM_OTP_AE_ERROR_PGMWPERR_SHIFT)) & MEM_OTP_AE_ERROR_PGMWPERR_MASK)
