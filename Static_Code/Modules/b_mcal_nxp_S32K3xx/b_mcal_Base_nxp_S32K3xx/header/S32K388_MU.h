...
typedef struct {
  ...
  __IO uint32_t CCR0;                              /**< Core Control Register 0, offset: 0x10, not available in all instances (available on 2 out of 8) */
  uint8_t RESERVED_0[4];
  __IO uint32_t CSSR0;                             /**< Core Sticky Status Register 0, offset: 0x18, not available in all instances (available on 2 out of 8) */
