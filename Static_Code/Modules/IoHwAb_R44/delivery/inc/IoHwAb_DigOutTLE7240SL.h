...
#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
extern FUNC(void, IOHWAB_CODE)IoHwAb_DigOutTLE7240SLGetOpenLoad(IoHwAb_IndexType ChIdx, 
...
#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
extern FUNC(void, IOHWAB_CODE)IoHwAb_DigOutTLE7240SLGetOverCurrent(IoHwAb_IndexType ChIdx, 
P2VAR(IoHwAb_LevelType, AUTOMATIC, IOHWAB_APPL_DATA) Level);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"
